...
function runDiff() {
    ...
    var precis = parseFloat(document.getElementById('floatPrecision').value)

    tableA = compTableFloatHeader(tableA, 4)
    tableB = compTableFloatHeader(tableB, 4)

    var ret = compTableExtraColExpoFloat(tableA, tableB, precis);
